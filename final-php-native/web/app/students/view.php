    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= url('app/students/') ?>">students</a></li>
                ...
                <div class="card shadow-lg border-0 p-3 bg-light">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <strong>group:</strong> <?= $admin['group_name'] ?>
                        </div>
                        <div class="mb-3">
                        <i class="bi bi-building"></i>
                            <strong>department:</strong> <?= $admin['department_name'] ?>
                        </div>
                    
                        <div class="mb-3">
                        <i class="bi bi-person-badge"></i>
                            <strong>instructor:</strong> <?= $admin['instructor_name'] ?>
                        </div>
                        <div class="mb-3">
                        <i class="bi bi-arrow-repeat"></i>
                            <strong>round:</strong> <?= $admin['rounds_name'] ?>
                        </div>
                    <div class="d-flex justify-content-between mt-4">
                        <a href="<?= url('app/students/') ?>" class="btn btn-outline-secondary">
                            <i class="bi bi-arrow-left"></i> Back
                        </a>
                        <a href="<?= url("app/students/edit.php?edit=") . $admin['student_id'] ?>" class="btn btn-warning">
